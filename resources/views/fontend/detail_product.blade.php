...
<div class="product-details"><!--product-details-->
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										<div class="item active">
										  <a href=""><img src="{{asset('public/fontend/image/similar1.jpg')}}" alt=""></a>
										  <a href=""><img src="{{asset('public/fontend/image/similar2.jpg')}}" alt=""></a>
										  <a href=""><img src="{{asset('public/fontend/image/similar3.jpg')}}" alt=""></a>
										</div>
										<div class="item">
										  <a href=""><img src="{{asset('public/fontend/image/similar1.jpg')}}" alt=""></a>
										  <a href=""><img src="{{asset('public/fontend/image/similar2.jpg')}}" alt=""></a>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<p>Thương hiệu: {{$item->pro_Thuonghieu}}</p>
								...
								<span>
									...
									<p>Kích thước: {{$item->pro_Kichthuoc}}</p><br>
